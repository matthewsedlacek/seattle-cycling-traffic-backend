...
#messages
message_1 = Message.create(user_name: Faker::Name.first_name, content: "So many people on this trail", bike_trail_id: 1)
message_2 = Message.create(user_name: Faker::Name.first_name, content: "Went on a sunny Sunday, not that many riders", bike_trail_id: 1)
message_3 = Message.create(user_name: Faker::Name.first_name, content: "My favorite trail!", bike_trail_id: 2)
message_4 = Message.create(user_name: Faker::Name.first_name, content: "Big crowd standing in the middle of the lane, told them to move", bike_trail_id: 2)
message_5 = Message.create(user_name: Faker::Name.first_name, content: "Nice trail", bike_trail_id: 3)
message_6 = Message.create(user_name: Faker::Name.first_name, content: "Love riding this trail", bike_trail_id: 3)
message_7 = Message.create(user_name: Faker::Name.first_name, content: "Driving next to the i-90 is cool", bike_trail_id: 4)
message_8 = Message.create(user_name: Faker::Name.first_name, content: "I would avoid this one", bike_trail_id: 4)
message_9 = Message.create(user_name: Faker::Name.first_name, content: "I love seeing the seals on Alki", bike_trail_id: 5)
message_10 = Message.create(user_name: Faker::Name.first_name, content: "WSB is CLOSED", bike_trail_id: 5)
message_11 = Message.create(user_name: Faker::Name.first_name, content: "I like this trail", bike_trail_id: 6)
message_12 = Message.create(user_name: Faker::Name.first_name, content: "I wonder why they call this ", bike_trail_id: 6)
message_13 = Message.create(user_name: Faker::Name.first_name, content: "I love biking downtown", bike_trail_id: 7)
message_14 = Message.create(user_name: Faker::Name.first_name, content: "Too many cars", bike_trail_id: 7)
message_15 = Message.create(user_name: Faker::Name.first_name, content: "A nice bike stroll", bike_trail_id: 8)
message_16 = Message.create(user_name: Faker::Name.first_name, content: "Saw a lot of dog walkers today", bike_trail_id: 8)
message_17 = Message.create(user_name: Faker::Name.first_name, content: "a trail through a neighborhood, nice", bike_trail_id: 9)
message_18 = Message.create(user_name: Faker::Name.first_name, content: "I wish people would respect the bike lane more", bike_trail_id: 9)
message_19 = Message.create(user_name: Faker::Name.first_name, content: "This bike lane is surprisingly long", bike_trail_id: 10)
...
# October 2020
burke_gilman_url =  "https://data.seattle.gov/resource/2z5v-ecg8.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
...
elliot_bay_url =  "https://data.seattle.gov/resource/4qej-qvrz.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
...
ship_canal_url =  "https://data.seattle.gov/resource/65db-xm6k.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
...
mts_url =  "https://data.seattle.gov/resource/u38e-ybnc.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
...
# wsb_counter
# October 2020
wsb_url =  "https://data.seattle.gov/resource/upms-nr8w.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
...
second_ave_url =  "https://data.seattle.gov/resource/avwm-i8ym.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
...
golden_gardens_url =  "https://data.seattle.gov/resource/47yq-6ugv.json?$where=date between '2020-10-01T00:00:00' and '2020-10-31T23:59:59'"
